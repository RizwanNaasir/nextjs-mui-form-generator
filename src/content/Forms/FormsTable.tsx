    ...
    await deleteDoc(doc(db, 'formBlueprints', id))
      ...
      .finally(() => {
        setLoadingRows((prevLoadingRows) =>
          prevLoadingRows.filter((row) => row !== id)
        );
      });
  };
              ...
              <TableBody>
                {loading || !formBlueprints
                  ...
                  : formBlueprints?.docs.map((formBlueprint, index) => {
                      ...
                      return (
                        <TableRow hover key={formBlueprint.id}>
                          <TableCell>
                            <Typography
                              variant="body1"
                              fontWeight="bold"
                            ...
                            >
                              ...
                              >
                                <span>
                                  <LoadingButton
                                    ...
                                    loading={loadingRows.includes(
                                      formBlueprint.id
                                    )} // Use loading state for the specific row
                                  >
                                    Export
                                  </LoadingButton>
                                </span>
                              ...
                              <LoadingButton
                                ...
                                onClick={async () => {
                                  ...
                                  setLoadingRows(
                                    loadingRows.filter(
                                      (id) => id !== formBlueprint.id
                                    )
                                  ); // Remove loading state for the specific row
                                }}
                                sx={{ ml: 1 }}
